...
- AgentDeck-owned Claude and Codex sessions receive the same file-presentation contract from `providers/instructions.py`: relative HTML links are cwd-scoped sandbox previews, while links to other generated files use absolute filesystem paths.
